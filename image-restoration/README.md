...
This project tackles image restoration and coloring for old damaged black and white images. The restoration problem tackels automatic damaged region detection which turns out to be a very hard problem to automate by classical means (as discussed below). The coloring portion Opencv DNN based Caffe framework to colorize black and white images.
